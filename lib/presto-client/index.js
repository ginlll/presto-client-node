...
Client.prototype.request = function(opts, callback) {
    ...
    if (client.user && !opts.headers[Headers.USER])
        opts.headers[Headers.USER] = client.user;

    if (client.source && !opts.headers[Headers.SOURCE])
...
Client.prototype.statementResource = function(opts) {
    ...
    header[Headers.USER] = opts.user || this.user;
    header[Headers.SOURCE] = opts.source || this.source;
        ...
        var fetch_next = function(next_uri){
            ...
            */
            ...
            client.request(next_uri, function(error, code, response){
                ...
                if (state_callback && response.stats && (last_state !== response.stats.state || enable_verbose_state_callback || current_ts - last_ts >= client.checkInterval)) {
                ...
                var fetchNextWithTimeout = function(uri) {
                    fetch_next(uri);
                };
                ...
                if (response.stats.state === 'QUEUED'
                    ...
                    fetchNextWithTimeout(response.nextUri);
                    return;
                }
